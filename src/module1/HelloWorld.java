...
public class HelloWorld extends PApplet
{
	...
	/** The second map displays Mountain View, CA */ 
	UnfoldingMap map2;
	...
	public void setup() {
		...
		this.background(100, 100, 400);
		
		// Select a map provider
		// AbstractMapProvider provider = new Google.GoogleTerrainProvider();
		// Changed to OpenStreetMap, exceeded number of Google queries
		...
		map2.zoomAndPanTo(zoomLevel, new Location(37.38f, -122.08f));
